...
router.post('/booking/:id/start', verifyToken, handleUpload('photo', 'vehicles'), bookingCtrl.startTrip);
router.post('/booking/:id/end', verifyToken, handleUpload('photo', 'vehicles'), bookingCtrl.endTrip);
