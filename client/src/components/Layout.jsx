...
const Layout = () => {
    ...
    return (
        <div className="flex bg-slate-50 h-screen font-sans text-slate-900 overflow-hidden print:h-auto print:overflow-visible print:bg-white print:block">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative print:h-auto print:overflow-visible print:w-full print:block">
                <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 lg:px-8 shrink-0 z-30 print:hidden">
                ...
                <main className="flex-1 overflow-auto p-4 lg:p-8 relative custom-scrollbar pb-16 lg:pb-8 flex flex-col justify-between print:p-0 print:m-0 print:overflow-visible print:block">
                    <div>
                        <Outlet />
                    </div>
                    <footer className="mt-8 pt-4 border-t border-slate-200 text-center text-xs text-slate-400 font-medium shrink-0 print:hidden">
                        &copy; Kepala Bidang Sarana 2025/2027 x PT. Nusantara Insan Olahkarya
                    </footer>
                </main>

                {/* Mobile Bottom Navigation */}
                <nav className="sm:hidden fixed bottom-1 left-2 right-2 bg-white/95 backdrop-blur-sm border border-slate-200 px-4 py-2 z-40 flex items-center justify-around rounded-2xl shadow-xl print:hidden">
                    {navItems.map((item) => {
