...
const ProcurementAssignmentOrderSign = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-100 text-slate-900 print:bg-white print:p-0">
            ...
            {/* Top Navigation Bar */}
            <header className="no-print bg-slate-900 text-white sticky top-0 z-30 shadow-md">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h1 className="text-sm font-bold tracking-tight">Surat Perintah Pengadaan</h1>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {procurement?.id && (
                            <Link
                                ...
                                className="hidden sm:flex items-center gap-1.5 px-3.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-medium rounded-xl border border-slate-700 transition-all"
                            >
