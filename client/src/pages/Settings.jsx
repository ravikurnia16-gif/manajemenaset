                            ...
                            <div className="border-t border-slate-100 p-6 bg-slate-50">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-200">
                                    ...
                                    <p className="text-[10px] text-slate-500 mb-2">
                                        Jika grup Anda tidak muncul di atas, Anda bisa menambahkan bot ke grup lalu ketik <strong>/idgrup</strong> di WA. Salin ID tersebut dan paste di sini (pisahkan dengan koma jika lebih dari satu).
                                    </p>
                                    <input
                                        type="text"
                                        value={settings.aiAllowedGroups || ''}
                                        onChange={e => setSettings({ ...settings, aiAllowedGroups: e.target.value })}
                                        className="w-full border border-slate-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none font-mono"
                                        placeholder="contoh: 123456789@g.us, 987654321@g.us"
                                    />
                                </div>
                            </div>
                        )}
